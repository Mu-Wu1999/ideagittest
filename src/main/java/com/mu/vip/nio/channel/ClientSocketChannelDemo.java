    ...
    public static class TCPEchoClient implements Runnable{
        ...
        public void run(){
            ...
            try {
                ...
                /*如果马上得到连接，返回true，如果没有得到连接，返回false ，一旦这个socketchannel有以上注册的事件可用，则
                * 会被唤醒，一旦被唤醒，则不断循环的sc.finishConnect() 会变成true*/
                sc.connect(remoteAddress);
                 
                /*等待三次握手完成，如果没连接成功，则执行里面的代码，如果连接成功socketchannel成功，则向下执行*/
            ...
            try{
                ...
                while(!Thread.currentThread().isInterrupted()){
                    ...
                    /*阻塞等待，一旦有socketchannel可用，就会向下执行，是selector的唤醒方法*/
                    selector.select();
